...
/*
Fragment che costituisce il menu di upgrade dell'unita di riciclo Plastica
 */
public class UpgradePlasticaFragment extends Fragment implements View.OnClickListener {
    ...
    public UpgradePlasticaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_upgrade_plastica, container, false);
        TextView textViewOggettiRiciclati = view.findViewById(R.id.totRiciclatiPlasticaNumeroTxt);
        String tot = Game.unitaRicicloArrayList.get(5).getTotOggettiRiciclati() + " ";
        textViewOggettiRiciclati.setText(tot);

        //inizializzo le stringhe con i valori presi dall'unita di riciclo Plastica e setto le textView associate
        upgradeTxt = view.findViewById(R.id.lvlUpgradePlasticaNumeroTxt);
        usuraTxt = view.findViewById(R.id.lvlUsuraPlasticaNumeroTxt);
        usura = Game.unitaRicicloArrayList.get(5).getLvlUsura()/2 + " ";
        usuraTxt.setText(usura);
        if(Game.unitaRicicloArrayList.get(5).getLvlUpgrade() > 2){
            upgrade = "MAX";
        }else {
            upgrade = Game.unitaRicicloArrayList.get(5).getLvlUpgrade() + " ";
        }
        upgradeTxt.setText(upgrade);
        btnUpgradeUnit = view.findViewById(R.id.aumentaLvlUnitaPlasticaBtn);
        if(Game.unitaRicicloArrayList.get(5).getLvlUpgrade() > 2 || Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() < 4){
            btnUpgradeUnit.setClickable(false);
            btnUpgradeUnit.setAlpha((float)0.20);
        }


        oggetto1 = view.findViewById(R.id.ricicloPlastica1Btn);
        oggetto2 = view.findViewById(R.id.ricicloPlastica2Btn);
        oggetto3 = view.findViewById(R.id.ricicloPlastica3Btn);
        numeroOggetto1Txt = view.findViewById(R.id.numeroOggettiCreatiPlastica1Txt);
        numeroOggetto2Txt = view.findViewById(R.id.numeroOggettiCreatiPlastica2Txt);
        numeroOggetto3Txt = view.findViewById(R.id.numeroOggettiCreatiPlastica3Txt);
        ricavoOggetto2Txt = view.findViewById(R.id.ricavoRicicloOggettoPlastica2Txt);
        ricavoOggetto3Txt = view.findViewById(R.id.ricavoRicicloOggettoPlastica3Txt);
        costoOggetto2Txt = view.findViewById(R.id.costoOggettoPlastica2Txt);
        costoOggetto3Txt = view.findViewById(R.id.costoOggettoPlastica3Txt);
        puntiRiciclaggioOggetto2Imm = view.findViewById(R.id.puntiRiciclaggiPlasticaImm3);
        puntiRiciclaggioOggetto3Imm = view.findViewById(R.id.puntiRiciclaggiPlasticaImm4);
        puntiSoleOggetto2Imm = view.findViewById(R.id.puntiSoleRicavoPlastica2Imm);
        puntiSoleOggetto3Imm = view.findViewById(R.id.puntiSoleRicavoPlastica3Imm);
        infOggetto2 = view.findViewById(R.id.informazioniCreazioneOggettoPlastica2Btn);
        infOggetto3 = view.findViewById(R.id.informazioniCreazioneOggettoPlastica3Btn);
        tempoLavorazioneTxt = view.findViewById(R.id.tempoRiciclaggioPlasticaTxt);

        if(Game.dimension == 1){//se la dimensione è 5" cambio le dimensioni del testo
            TextView tipoUnitatxt = view.findViewById(R.id.tipoUnitaRicicloPlasticaTxt);
            TextView lvlUpgradeTxt = view.findViewById(R.id.lvlUpgradePlasticaTxt);
            TextView lvlUsuraTxt = view.findViewById(R.id.lvlUsuraPlasticaTxt);
            TextView lvlTotOggetti = view.findViewById(R.id.totRiciclatiPlasticaTxt);
            TextView lvlMaxUsura = view.findViewById(R.id.lvlUsuraMaxPlasticaTxt);
       ...
       checkUnitUpgrade();
        ...
        numeroOggetto1 = "n: " + Game.unitaRicicloArrayList.get(5).getOggettoRiciclo1();
        ...
        if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() < 2){
        ...
        numeroOggetto2 = "n: " + Game.unitaRicicloArrayList.get(5).getOggettoRiciclo2();
        ...
        // se non si hanno i punti necessari
        if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() < 4){
        ...
        numeroOggetto3 = "n: " + Game.unitaRicicloArrayList.get(5).getOggettoRiciclo3();
        ...
        // se non si hanno i punti necessari
        if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() < 7){
    ...
    */
    private void setTempoLavorazioneTxt(){
        ...
        if(Game.unitaRicicloArrayList.get(5).getLvlUpgrade() == 1){
            tempoLavorazione = "Tempo lavorazione:5s";
        }else if(Game.unitaRicicloArrayList.get(5).getLvlUpgrade() == 2){
    ...
    private void checkUnitUpgrade(){
        ...
        if(Game.unitaRicicloArrayList.get(5).getLvlUpgrade() >= 3){
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.aumentaLvlUnitaPlasticaBtn:
                if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() >= 4) {// se si hanno i punti necessari
                    Game.unitaRicicloArrayList.get(5).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() - 4);//sottrai prezzo pagato
                    Game.unitaRicicloArrayList.get(5).setLvlUpgrade(Game.unitaRicicloArrayList.get(5).getLvlUpgrade() + 1);//aumenta livello unita
                    //aggiorna informazioni unita
                    upgrade = Game.unitaRicicloArrayList.get(5).getLvlUpgrade() + " ";
                    Game.unitaRicicloArrayList.get(5).setLvlUsura(0);
                    usura = Game.unitaRicicloArrayList.get(5).getLvlUsura() + " ";
                    usuraTxt.setText(usura);
                    ...
                    else if (Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() < 4) {
                        //rende il bottone non cliccabile e trasparente
                        btnUpgradeUnit.setClickable(false);
                        btnUpgradeUnit.setAlpha((float) 0.20);
                    }
               ...
               checkButtonNewOggetto();
                break;
            case R.id.ricicloPlastica1Btn:
                //se si hanno i punti necessari alla produzione di un oggetto di lvl 1
                if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() >= 2){
                    //guadagna 1 punti sole
                    Game.puntiSole = Game.puntiSole + 1;
                    Game.unitaRicicloArrayList.get(5).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() - 2);
                    //aggiorna conteggio oggetti di lvl1 prodotti
                    Game.unitaRicicloArrayList.get(5).setOggettoRiciclo1(Game.unitaRicicloArrayList.get(5).getOggettoRiciclo1() + 1);
                    numeroOggetto1 = "n: " + Game.unitaRicicloArrayList.get(5).getOggettoRiciclo1();
                    numeroOggetto1Txt.setText(numeroOggetto1);
            ...
            case R.id.ricicloPlastica2Btn:
                ...
                if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() >= 4){
                    ...
                    Game.unitaRicicloArrayList.get(5).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() - 4);
                    //aggiorna conteggio oggetti di lvl2 prodotti
                    Game.unitaRicicloArrayList.get(5).setOggettoRiciclo2(Game.unitaRicicloArrayList.get(5).getOggettoRiciclo2() + 1);
                    numeroOggetto2 = "n: " + Game.unitaRicicloArrayList.get(5).getOggettoRiciclo2();
                    numeroOggetto2Txt.setText(numeroOggetto2);
            ...
            case R.id.ricicloPlastica3Btn:
                //se si hanno i punti necessari alla produzione di un oggetto di lvl 3
                if(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() >= 7){
                    //guadagna 6 punti sole
                    Game.puntiSole = Game.puntiSole + 6;
                    //paga 7 punti riciclaggio
                    Game.unitaRicicloArrayList.get(5).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(5).getPuntiRiciclaggio() - 7);
                    //aggiorna conteggio oggetti di lvl3 prodotti
                    Game.unitaRicicloArrayList.get(5).setOggettoRiciclo3(Game.unitaRicicloArrayList.get(5).getOggettoRiciclo3() + 1);
                    numeroOggetto3 = "n: " + Game.unitaRicicloArrayList.get(5).getOggettoRiciclo3();
                    numeroOggetto3Txt.setText(numeroOggetto3);
                }

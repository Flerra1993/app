...
/*
Fragment che costituisce il menu di upgrade dell'unita di riciclo Alluminio
 */
public class UpgradeAlluminioFragment extends Fragment implements View.OnClickListener {
    ...
    public UpgradeAlluminioFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_upgrade_alluminio, container, false);
        TextView textViewOggettiRiciclati = view.findViewById(R.id.totRiciclatiAlluminioNumeroTxt);
        String tot = Game.unitaRicicloArrayList.get(4).getTotOggettiRiciclati() + " ";
        textViewOggettiRiciclati.setText(tot);

        //inizializzo le stringhe con i valori presi dall'unita di riciclo Alluminio e setto le textView associate
        upgradeTxt = view.findViewById(R.id.lvlUpgradeAlluminioNumeroTxt);
        usuraTxt = view.findViewById(R.id.lvlUsuraAlluminioNumeroTxt);
        usura = Game.unitaRicicloArrayList.get(4).getLvlUsura()/2 + " ";
        usuraTxt.setText(usura);
        if(Game.unitaRicicloArrayList.get(4).getLvlUpgrade() > 2){
            upgrade = "MAX";
        }else {
            upgrade = Game.unitaRicicloArrayList.get(4).getLvlUpgrade() + " ";
        }
        upgradeTxt.setText(upgrade);
        btnUpgradeUnit = view.findViewById(R.id.aumentaLvlUnitaAlluminioBtn);
        if(Game.unitaRicicloArrayList.get(4).getLvlUpgrade() > 2 || Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() < 4){
        ...
        oggetto1 = view.findViewById(R.id.ricicloAlluminio1Btn);
        oggetto2 = view.findViewById(R.id.ricicloAlluminio2Btn);
        oggetto3 = view.findViewById(R.id.ricicloAlluminio3Btn);
        numeroOggetto1Txt = view.findViewById(R.id.numeroOggettiCreatiAlluminio1Txt);
        numeroOggetto2Txt = view.findViewById(R.id.numeroOggettiCreatiAlluminio2Txt);
        numeroOggetto3Txt = view.findViewById(R.id.numeroOggettiCreatiAlluminio3Txt);
        ricavoOggetto2Txt = view.findViewById(R.id.ricavoRicicloOggettoAlluminio2Txt);
        ricavoOggetto3Txt = view.findViewById(R.id.ricavoRicicloOggettoAlluminio3Txt);
        costoOggetto2Txt = view.findViewById(R.id.costoOggettoAlluminio2Txt);
        costoOggetto3Txt = view.findViewById(R.id.costoOggettoAlluminio3Txt);
        puntiRiciclaggioOggetto2Imm = view.findViewById(R.id.puntiRiciclaggiAlluminioImm3);
        puntiRiciclaggioOggetto3Imm = view.findViewById(R.id.puntiRiciclaggiAlluminioImm4);
        puntiSoleOggetto2Imm = view.findViewById(R.id.puntiSoleRicavoAlluminio2Imm);
        puntiSoleOggetto3Imm = view.findViewById(R.id.puntiSoleRicavoAlluminio3Imm);
        infOggetto2 = view.findViewById(R.id.informazioniCreazioneOggettoAlluminio2Btn);
        infOggetto3 = view.findViewById(R.id.informazioniCreazioneOggettoAlluminio3Btn);
        tempoLavorazioneTxt = view.findViewById(R.id.tempoRiciclaggioAlluminioTxt);

        if(Game.dimension == 1){//se la dimensione è 5" cambio le dimensioni del testo
            TextView tipoUnitatxt = view.findViewById(R.id.tipoUnitaRicicloAlluminioTxt);
            TextView lvlUpgradeTxt = view.findViewById(R.id.lvlUpgradeAlluminioTxt);
            TextView lvlUsuraTxt = view.findViewById(R.id.lvlUsuraAlluminioTxt);
            TextView lvlTotOggetti = view.findViewById(R.id.totRiciclatiAlluminioTxt);
            TextView lvlMaxUsura = view.findViewById(R.id.lvlUsuraAlluminioMaxTxt);
        ...
        numeroOggetto1 = "n: " + Game.unitaRicicloArrayList.get(4).getOggettoRiciclo1();
        ...
        if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() < 2){
        ...
        numeroOggetto2 = "n: " + Game.unitaRicicloArrayList.get(4).getOggettoRiciclo2();
        ...
        // se non si hanno i punti necessari
        if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() < 4){
        ...
        numeroOggetto3 = "n: " + Game.unitaRicicloArrayList.get(4).getOggettoRiciclo3();
        ...
        // se non si hanno i punti necessari
        if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() < 7){
    ...
    */
    private void setTempoLavorazioneTxt(){
        ...
        if(Game.unitaRicicloArrayList.get(4).getLvlUpgrade() == 1){
            tempoLavorazione = "Tempo lavorazione:5s";
        }else if(Game.unitaRicicloArrayList.get(4).getLvlUpgrade() == 2){
    ...
    private void checkUnitUpgrade(){
        ...
        if(Game.unitaRicicloArrayList.get(4).getLvlUpgrade() >= 3){
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.aumentaLvlUnitaAlluminioBtn:
                if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() >= 4) {// se si hanno i punti necessari
                    Game.unitaRicicloArrayList.get(4).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() - 4);//sottrai prezzo pagato
                    Game.unitaRicicloArrayList.get(4).setLvlUpgrade(Game.unitaRicicloArrayList.get(4).getLvlUpgrade() + 1);//aumenta livello unita
                    //aggiorna informazioni unita
                    upgrade = Game.unitaRicicloArrayList.get(4).getLvlUpgrade() + " ";
                    Game.unitaRicicloArrayList.get(4).setLvlUsura(0);
                    usura = Game.unitaRicicloArrayList.get(4).getLvlUsura() + " ";
                    usuraTxt.setText(usura);
                    ...
                    else if (Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() < 4) {
                        //rende il bottone non cliccabile e trasparente
                        btnUpgradeUnit.setClickable(false);
                        btnUpgradeUnit.setAlpha((float) 0.20);
                    }
            ...
            case R.id.ricicloAlluminio1Btn:
                ...
                if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() >= 2){
                    ...
                    Game.unitaRicicloArrayList.get(4).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() - 2);
                    //aggiorna conteggio oggetti di lvl1 prodotti
                    Game.unitaRicicloArrayList.get(4).setOggettoRiciclo1(Game.unitaRicicloArrayList.get(4).getOggettoRiciclo1() + 1);
                    numeroOggetto1 = "n: " + Game.unitaRicicloArrayList.get(4).getOggettoRiciclo1();
                    numeroOggetto1Txt.setText(numeroOggetto1);
            ...
            case R.id.ricicloAlluminio2Btn:
                ...
                if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() >= 4){
                    ...
                    Game.unitaRicicloArrayList.get(4).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() - 4);
                    //aggiorna conteggio oggetti di lvl2 prodotti
                    Game.unitaRicicloArrayList.get(4).setOggettoRiciclo2(Game.unitaRicicloArrayList.get(4).getOggettoRiciclo2() + 1);
                    numeroOggetto2 = "n: " + Game.unitaRicicloArrayList.get(4).getOggettoRiciclo2();
                    numeroOggetto2Txt.setText(numeroOggetto2);
            ...
            case R.id.ricicloAlluminio3Btn:
                ...
                if(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() >= 7){
                    ...
                    Game.unitaRicicloArrayList.get(4).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(4).getPuntiRiciclaggio() - 7);
                    //aggiorna conteggio oggetti di lvl3 prodotti
                    Game.unitaRicicloArrayList.get(4).setOggettoRiciclo3(Game.unitaRicicloArrayList.get(4).getOggettoRiciclo3() + 1);
                    numeroOggetto3 = "n: " + Game.unitaRicicloArrayList.get(4).getOggettoRiciclo3();
                    numeroOggetto3Txt.setText(numeroOggetto3);
                }

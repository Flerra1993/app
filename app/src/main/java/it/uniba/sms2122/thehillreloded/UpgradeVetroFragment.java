...
/*
Fragment che costituisce il menu di upgrade dell'unita di riciclo Vetro
 */
public class UpgradeVetroFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_upgrade_vetro, container, false);
        TextView textViewOggettiRiciclati = view.findViewById(R.id.totRiciclatiVetroNumeroTxt);
        String tot = Game.unitaRicicloArrayList.get(1).getTotOggettiRiciclati()+ " ";
        textViewOggettiRiciclati.setText(tot);

        //inizializzo le stringhe con i valori presi dall'unita di riciclo Vetro e setto le textView associate
        upgradeTxt = view.findViewById(R.id.lvlUpgradeVetroNumeroTxt);
        usuraTxt = view.findViewById(R.id.lvlUsuraNumeroVetroTxt);
        usura = Game.unitaRicicloArrayList.get(1).getLvlUsura()/2 + " ";
        usuraTxt.setText(usura);
        if(Game.unitaRicicloArrayList.get(1).getLvlUpgrade() > 2){
            upgrade = "MAX";
        }else {
            upgrade = Game.unitaRicicloArrayList.get(1).getLvlUpgrade()+ " ";
        }
        upgradeTxt.setText(upgrade);
        btnUpgradeUnit = view.findViewById(R.id.aumentaLvlUnitaVetroBtn);
        if(Game.unitaRicicloArrayList.get(1).getLvlUpgrade() > 2 || Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() < 4){
            btnUpgradeUnit.setClickable(false);
            btnUpgradeUnit.setAlpha((float)0.20);
        }


        oggetto1 = view.findViewById(R.id.ricicloVetro1Btn);
        oggetto2 = view.findViewById(R.id.ricicloVetro2Btn);
        oggetto3 = view.findViewById(R.id.ricicloVetro3Btn);
        numeroOggetto1Txt = view.findViewById(R.id.numeroOggettiCreatiVetro1Txt);
        numeroOggetto2Txt = view.findViewById(R.id.numeroOggettiCreatiVetro2Txt);
        numeroOggetto3Txt = view.findViewById(R.id.numeroOggettiCreatiVetro2Txt2);
        ricavoOggetto2Txt = view.findViewById(R.id.ricavoRicicloOggettoVetro2Txt);
        ricavoOggetto3Txt = view.findViewById(R.id.ricavoRicicloOggettoVetro3Txt);
        costoOggetto2Txt = view.findViewById(R.id.costoOggettoVetro2Txt);
        costoOggetto3Txt = view.findViewById(R.id.costoOggettoVetro3Txt);
        puntiRiciclaggioOggetto2Imm = view.findViewById(R.id.puntiRiciclaggiVetroImm3);
        puntiRiciclaggioOggetto3Imm = view.findViewById(R.id.puntiRiciclaggiVetroImm4);
        puntiSoleOggetto2Imm = view.findViewById(R.id.puntiSoleRicavoVetro2Imm);
        puntiSoleOggetto3Imm = view.findViewById(R.id.puntiSoleRicavoVetro3Imm);
        infOggetto2 = view.findViewById(R.id.informazioniCreazioneOggettoVetro2Btn);
        infOggetto3 = view.findViewById(R.id.informazioniCreazioneOggettoVetro3Btn);
        tempoLavorazioneTxt = view.findViewById(R.id.tempoRiciclaggioVetroTxt);

        if(Game.dimension == 1){//se la dimensione è 5" cambio le dimensioni del testo
            TextView tipoUnitatxt = view.findViewById(R.id.tipoUnitaRicicloVetroTxt);
            TextView lvlUpgradeTxt = view.findViewById(R.id.lvlUpgradeVetroTxt);
            TextView lvlUsuraTxt = view.findViewById(R.id.lvlUsuraVetroTxt);
            TextView lvlTotOggetti = view.findViewById(R.id.totRiciclatiVetroTxt);
            TextView lvlMaxUsura = view.findViewById(R.id.lvlUsuraMaxVetroTxt);
        ...
        numeroOggetto1 = "n: " + Game.unitaRicicloArrayList.get(1).getOggettoRiciclo1();
        ...
        if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() < 2){
        ...
        numeroOggetto2 = "n: " + Game.unitaRicicloArrayList.get(1).getOggettoRiciclo2();
        ...
        // se non si hanno i punti necessari
        if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() < 4){
        ...
        numeroOggetto3 = "n: " + Game.unitaRicicloArrayList.get(1).getOggettoRiciclo3();
        ...
        // se non si hanno i punti necessari
        if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() < 7){
    ...
    */
    private void setTempoLavorazioneTxt(){
        ...
        if(Game.unitaRicicloArrayList.get(1).getLvlUpgrade() == 1){
            tempoLavorazione = "Tempo lavorazione:5s";
        }else if(Game.unitaRicicloArrayList.get(1).getLvlUpgrade() == 2){
    ...
    private void checkUnitUpgrade(){
        ...
        if(Game.unitaRicicloArrayList.get(1).getLvlUpgrade() >= 3){
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.aumentaLvlUnitaVetroBtn:
                if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() >= 4) {// se si hanno i punti necessari
                    Game.unitaRicicloArrayList.get(1).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() - 4);//sottrai prezzo pagato
                    Game.unitaRicicloArrayList.get(1).setLvlUpgrade(Game.unitaRicicloArrayList.get(1).getLvlUpgrade() + 1);//aumenta livello unita
                    //aggiorna informazioni unita
                    upgrade = Game.unitaRicicloArrayList.get(1).getLvlUpgrade() + " ";
                    Game.unitaRicicloArrayList.get(1).setLvlUsura(0);
                    usura = Game.unitaRicicloArrayList.get(1).getLvlUsura() + " ";
                    usuraTxt.setText(usura);

                    if(MissionFragment.numeroMissione == 1){
                        MissionFragment.numeroMissione = 2;
                    ...
                    else if (Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() < 4) {
                        //rende il bottone non cliccabile e trasparente
                        btnUpgradeUnit.setClickable(false);
                        btnUpgradeUnit.setAlpha((float) 0.20);
                    }
              ...
              checkButtonNewOggetto();
                break;
            case R.id.ricicloVetro1Btn:
                //se si hanno i punti necessari alla produzione di un oggetto di lvl 1
                if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() >= 2){
                    //guadagna un punto sole
                    Game.puntiSole = Game.puntiSole + 1;
                    //paga 2 punti riciclaggio
                    Game.unitaRicicloArrayList.get(1).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() - 2);
                    //aggiorna conteggio oggetti di lvl1 prodotti
                    Game.unitaRicicloArrayList.get(1).setOggettoRiciclo1(Game.unitaRicicloArrayList.get(1).getOggettoRiciclo1() + 1);
                    numeroOggetto1 = "n: " + Game.unitaRicicloArrayList.get(1).getOggettoRiciclo1();
                    numeroOggetto1Txt.setText(numeroOggetto1);
            ...
            case R.id.ricicloVetro2Btn:
                ...
                if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() >= 4){
                    ...
                    Game.unitaRicicloArrayList.get(1).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() - 4);
                    //aggiorna conteggio oggetti di lvl2 prodotti
                    Game.unitaRicicloArrayList.get(1).setOggettoRiciclo2(Game.unitaRicicloArrayList.get(1).getOggettoRiciclo2() + 1);
                    numeroOggetto2 = "n: " + Game.unitaRicicloArrayList.get(1).getOggettoRiciclo2();
                    numeroOggetto2Txt.setText(numeroOggetto2);
            ...
            case R.id.ricicloVetro3Btn:
                ...
                if(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() >= 7){
                    ...
                    Game.unitaRicicloArrayList.get(1).setPuntiRiciclaggio(Game.unitaRicicloArrayList.get(1).getPuntiRiciclaggio() - 7);
                    //aggiorna conteggio oggetti di lvl3 prodotti
                    Game.unitaRicicloArrayList.get(1).setOggettoRiciclo3(Game.unitaRicicloArrayList.get(1).getOggettoRiciclo3() + 1);
                    numeroOggetto3 = "n: " + Game.unitaRicicloArrayList.get(1).getOggettoRiciclo3();
                    numeroOggetto3Txt.setText(numeroOggetto3);
                }
